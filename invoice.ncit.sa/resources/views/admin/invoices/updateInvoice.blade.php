...
@section('title', __('text.update_invoice'))
@section('content')
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator"> {{__('text.update_invoice')}} </h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">{{__('text.update_invoice')}} </span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="m-content">
        ...
        <div class="m-portlet">
            ...
            <form class="m-form m-form--fit m-form--label-align-right" method="post" id="m_form_1"
                enctype="multipart/form-data" action="{{route('invoices.update',$invoice)}}" role="form">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <select class="form-control m-input m-input--air m-input--pill client_id" name='client_id'
                                style="height: 50px;" data-show-subtext="true" data-live-search="true" required="">
                                <option value="-1"> {{__('text.select')}}</option>
                                @foreach ($clients as $client)
                                <option value="{{$client->id}}" @if($invoice->client_id==$client->id)
                                    selected=""
                                    @endif
                                    >{{$client->name}}</option>
                                @endforeach
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <input type="datetime-local" class="form-control m-input m-input--air m-input--pill"
                                ...
                                value="{{date('Y-m-d\TH:i', strtotime($invoice->sdate))  }}">
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <select class="form-control  status" id="status" name='status' style="height: 50px;"
                                ...
                                <option @if ($invoice->status==1) selected @endif value="1">مدفوع</option>
                                <option @if ($invoice->status==2)selected @endif value="2">غير مدفوع </option>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <textarea class="form-control m-input m-input--air m-input--pill note" rows="7" name="note"
                                placeholder=" {{__('text.note')}}  ">{{$invoice->note}}</textarea>
                        </div>
                    </div>
                                        ...
                                        <tr id='addr{{$i-1}}'>
                                            ...
                                            <td>
                                                <select class="form-control  item" id="item" name='item[]'
                                                    ...
                                                    <option @if($p->item_id==$item->id) selected @endif
                                            ...
                                            <td>
                                                <input type="number" name='quantity[]'
                                                    ...
                                                    onchange="getTotal(this)" value="{{$p->quantity}}" required />
                                            </td>
                                            <td>
                                                <input type="number" name='cost[]' placeholder="{{__(' text.cost')}}"
                                                    class="form-control " onchange="getTotal(this)" value="{{$p->cost}}"
                                                    required />
                                            </td>
                                            <td>
                                                <input type="number" name='total[]' placeholder="{{__(' text.cost')}}"
                                                    class="form-control" disabled value="{{$p->cost*$p->quantity}}"
                                                    required />
                                            </td>
                                        </tr>
                                        @php
