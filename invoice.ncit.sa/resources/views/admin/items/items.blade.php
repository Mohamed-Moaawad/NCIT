    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">{{__('text.items')}}</h3>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#create-new-info').click(function () {
                ...
                $('#infoCrudModal').html("{{__('text.add_item')}}");
            ...
            $('body').on('click', '#edit-info', function () {
                ...
                $.get($(this).attr('value'), function (data) {
                    ...
                    $('.modal-footer').show();
                    $('#infoCrudModal').html("{{__('text.update_item')}}");
                    $('#btn-save').val("edit");
                    $('#ajax-crud-modal').modal('show');
                    $('#info_id').val(data.id);
                    $('#name').val(data.name);
    ...
    <script>
        $('#m_table_gz tbody').on('click', '.delete-post-link', function (e) {
            ...
            swal({
                    ...
                    text: "{{__('text.delete_qu')}} {{__('text.item')}}",
                    type: "warning",
